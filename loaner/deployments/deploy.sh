...
auth login"
  ...
  bazel build //loaner/deployments:deploy_impl --incompatible_disable_deprecated_attr_params=false --verbose_failures

  info_message "Completed Build"
