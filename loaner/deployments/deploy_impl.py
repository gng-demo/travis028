...
class AppEngineServerConfig(LoanerConfig):
  ...
  def _BuildWebAppBackend(self):
    ...
    _ExecuteCommand([
        'bazel', 'build', '//{}:{}'.format(
            self._web_app_dir, self._build_target,),'--incompatible_disable_deprecated_attr_params=false','--verbose_failures'])
...
if __name__ == '__main__':
  logging.debug('Find this ')
  logging.info('hopeufully fine dthi s')
